...
import { 
  ...
  ChevronRight, Hash, DollarSign, Package
} from "lucide-react";
import Link from "next/link";
import type { CurrentStage, SLAStatus } from "@/types";
import { TeamRequestActions } from "@/components/procurement/TeamRequestActions";
...
export const metadata: Metadata = { title: "Request Details - ProcureX" };
    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-16">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-400">
          <Link href="/team/requests" className="hover:text-indigo-600 transition-colors">
            Requests
          </Link>
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-white border border-slate-200/80 rounded-[2rem] p-6 shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
            ...
            <Link
              href={`/team/requests/${request.id}/srf`}
              target="_blank"
            ...
            <Link
              href={`/team/requests?search=${request.sourceNo}`}
      ...
      {/* Task Actions Panel for Assigned Team Member */}
      <TeamRequestActions
        requestId={request.id}
        sourceNo={request.sourceNo}
        csStatus={request.csStatus}
        currentStatusByHandler={request.currentStatusByHandler}
        currentStage={request.currentStage}
      />
