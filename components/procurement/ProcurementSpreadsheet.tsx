...
export function ProcurementSpreadsheet({ session }: Props) {
  ...
  const headerCellClass = "px-3.5 py-3.5 text-[11px] font-bold text-indigo-950 uppercase tracking-wider border-r border-indigo-100/80 border-b-2 border-b-indigo-500/80 bg-indigo-50/80 backdrop-blur-md text-left sticky top-0 z-20 select-none whitespace-nowrap shadow-sm";
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.06)] flex flex-col flex-1">
        <div className="overflow-auto custom-scrollbar flex-1" style={{ maxHeight: "calc(100vh - 220px)", minHeight: "500px" }}>
          <table className="w-full text-sm table-fixed min-w-[5000px] border-collapse">
            <thead>
              <tr>
                <th className="px-3 py-3.5 text-[11px] font-extrabold text-indigo-950 uppercase tracking-wider border-r-2 border-indigo-200 border-b-2 border-b-indigo-500/80 bg-indigo-100/90 backdrop-blur-md sticky top-0 left-0 z-30 text-center w-28 select-none shadow-[4px_0_12px_rgba(79,70,229,0.08)]">
                  Actions
                </th>
