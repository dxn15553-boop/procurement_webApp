...
export function ProcurementSpreadsheet({ session }: Props) {
  ...
  const headerCellClass = "px-3.5 py-3.5 text-[11px] font-semibold text-slate-700 uppercase tracking-wider border-r border-slate-200/80 border-b border-slate-200 bg-white text-left sticky top-0 z-20 select-none whitespace-nowrap shadow-[0_1px_2px_rgba(0,0,0,0.03)]";
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.06)] flex flex-col flex-1">
        <div className="overflow-auto custom-scrollbar flex-1" style={{ maxHeight: "calc(100vh - 220px)", minHeight: "500px" }}>
          <table className="w-full text-sm table-fixed min-w-[5000px] border-collapse">
            <thead>
              <tr>
                <th className="px-3 py-3.5 text-[11px] font-semibold text-slate-800 uppercase tracking-wider border-r border-slate-200 border-b border-slate-200 bg-white sticky top-0 left-0 z-30 text-center w-28 select-none shadow-[2px_0_6px_rgba(0,0,0,0.03)]">
                  Actions
                </th>
