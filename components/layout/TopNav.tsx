...
export function TopNav({ title }: TopNavProps) {
  ...
  return (
    <header className="h-16 bg-white/95 backdrop-blur-md flex items-center px-4 md:px-6 gap-4 sticky top-0 z-30 border-b border-slate-100 shadow-[0_2px_10px_rgb(0,0,0,0.02)]">
      {/* Mobile Menu Toggle */}
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <div className="relative">
          ...
          >
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-indigo-500 to-violet-600 flex items-center justify-center text-white text-sm font-bold shadow-sm shadow-indigo-500/20">
          ...
          {profileOpen && (
            <>
              ...
              />
              <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-100 rounded-2xl py-1 z-20 shadow-xl shadow-slate-200/50">
